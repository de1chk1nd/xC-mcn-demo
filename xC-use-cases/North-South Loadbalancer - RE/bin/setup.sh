...
export UBUNTU_NLB_EU_CENTRAL=$(terraform -chdir="./infrastructure" output ubuntu-01-nlb-private-eu-central-1 | tr -d '\"')
export UBUNTU_NLB_EU_WEST=$(terraform -chdir="./infrastructure" output ubuntu-01-nlb-private-eu-west-1 | tr -d '\"')
